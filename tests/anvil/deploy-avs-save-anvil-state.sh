...
cd ../../contracts
forge script script/NewsletterPromptDeployer.s.sol --rpc-url $RPC_URL --private-key $PRIVATE_KEY --broadcast -v --gas-price 100000000000 --priority-gas-price 100000000000 --legacy
